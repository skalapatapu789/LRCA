<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_TCourseApps.aspx.cs" Inherits="LRCA.MDE_TCourseApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Pending Training Courses applications</span>
                    </li>
                </ol>
            </div>
          ...
          Training Courses applications
            ...
            <small>This module is for MDE staff to manage Pending Training Courses applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Pending Training Courses applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           My Training Courses applications
                        </a>
                    </div>
