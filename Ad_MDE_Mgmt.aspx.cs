...
namespace LRCA
{
    public partial class Ad_MDE_Mgmt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                string strSQL = @"SELECT  User.AuthorisedUserId, User.FName, User.LName, User.EmailId, User.IsActive, UserRole.RoleId, UserRole.IsActive AS RoleStatus, UserRole.CreatedDate, UserRole.UserRoleId
                FROM User INNER JOIN  UserRole ON User.AuthorisedUserId = UserRole.AuthorizedUserId
