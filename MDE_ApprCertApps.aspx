<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_ApprCertApps.aspx.cs" Inherits="LRCA.MDE_ApprCertApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Approved/Rejected Accreditations applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Trainee Applications for Certification and  Accreditations
            </h2>
            <small>This module is for MDE staff to manage Approved/Rejected Trainee Certification & Accreditations Applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Approved Certification Accreditations Applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Rejected/On Hold/Deficient Certification & Accreditations Applications
                        </a>
                    </div>
