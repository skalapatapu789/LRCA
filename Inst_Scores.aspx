<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Inst_Scores.aspx.cs" Inherits="LRCA.Inst_Scores" %>
...
<div class="transition animated fadeIn">
      <div class="hpanel">
        <div class="panel-body">
         ...
         <asp:Label ID="lblCrouseName" runat="server" ></asp:Label></span>         
            </h2>
