<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_AddEmp.aspx.cs" Inherits="LRCA.MDE_AddEmp" %>
    ...
    <div class="hpanel">
        <div class="panel-body">
           ...
           MDE Management
            ...
            <small>This module is for MDE staff to manage MDE Account.</small>
        </div>
    </div>
</div>
    ...
    <script src="CSSBackEnd/js/plugin/datatables/jquery.dataTables-cust.min.js"></script>
		...
		<script type="text/javascript">
		    ...
		    function CallAjax(cgi) {
		        $.ajax({
		            type: "POST",
		            url: "MDE_AddEmp.aspx/CallMgmtRole",
		            data: "{\"cgi\":\"" + cgi + "\"}",
