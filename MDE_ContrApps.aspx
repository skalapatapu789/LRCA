<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_ContrApps.aspx.cs" Inherits="LRCA.MDE_ContrApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Pending Contractor Accreditations applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Contractor Accreditations applications
            </h2>
            <small>This module is for MDE staff to manage Pending Contractor Accreditations applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Pending Contractor Accreditations applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           My Contractor Accreditations applications
                        </a>
                    </div>
