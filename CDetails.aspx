<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CDetails.aspx.cs" Inherits="LRCA.CDetails" %>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" data-offset="51">
    ...
    <div class="section-inner">
         ...
         <div class="row">
                    <div class="col-md-10; well" style="background-color:#fff">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section-title text-left">
                                    <h4 class="main-title" style="color:#c11010"><asp:Label ID="lblTitle" runat="server" ></asp:Label></h4>
                                    <h5 class="sub-title"><asp:Label ID="lblDesc" runat="server" ></asp:Label></h5>
                                </div>
                           </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group"><label class="col-sm-10 control-label"><b>Training Provider</b></label>
                    <div class="col-sm-10">
                     <asp:Label ID="lblTP" runat="server" ></asp:Label>
                    </div></div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group"><label class="col-sm-10 control-label"><b>Location</b></label>
                    <div class="col-sm-10">
                    <asp:Label ID="lblLocation" runat="server" ></asp:Label>
                    </div></div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group"><label class="col-sm-10 control-label"><b>Language</b></label>
                    <div class="col-sm-10">
                     <asp:Label ID="lblLanguage" runat="server" ></asp:Label>
                    </div></div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group"><label class="col-sm-10 control-label"><b>Start Date</b></label>
                    <div class="col-sm-10">
                    <asp:Label ID="lblStartDate" runat="server" ></asp:Label>
                    </div></div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group"><label class="col-sm-10 control-label"><b>End Date</b></label>
                    <div class="col-sm-10">
                     <asp:Label ID="lblEndDate" runat="server" ></asp:Label>
                    </div></div>
                            </div>
                            <div class="col-md-1">
                                <a href="default.aspx#our-main-skills" class="btn btn-default">Back to List</a>
                            </div>
                            <div class="col-md-1">
                                <a href='#' data-toggle='modal' data-target='#RegisterClassModal' class='btn btn-primary' data-theVideo='RegisterClass.aspx' title='Register Class'>Register</a>
                            </div>
                        </div>
  ...
  <div class="modal fade" id="RegisterClassModal" tabindex="-1" role="dialog" aria-labelledby="RegisterClassModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <div>
                    <iframe scrolling="no" width="100%" height="350" style="float: none; margin: 0; border:thin; border-width:1px; border-color:#ccc; overflow:hidden;"  src="RegisterClass.aspx"></iframe>
                </div>
            </div>
        </div>
    </div>
