<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_CertApps.aspx.cs" Inherits="LRCA.MDE_CertApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Pending Accreditations applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Trainee Applications for Accreditations
            </h2>
            <small>This module is for MDE staff to manage Pending Trainee Accreditations Applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Pending Certification Accreditations Applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           My Accreditations Applications
                        </a>
                    </div>
