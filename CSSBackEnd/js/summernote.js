  ...
  var Renderer = function () {
    ...
    tplDialog = function (lang, options) {
      var tplImageDialog = function () {
        return '<div class="note-image-dialog modal fade In" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">' +
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     ...
                     '<div class="modal-footer">' +
                       '<button type="button" class="close" aria-hidden="true" tabindex="-1">Close</button><button href="#" class="btn btn-primary note-image-btn disabled" disabled="disabled">' + lang.image.insert + '</button>' +
                     '</div>' +
                   '</div>' +
                 '</div>' +
               '</div>';
      ...
      var tplLinkDialog = function () {
        return '<div class="note-link-dialog modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">' +
                 '<div class="modal-dialog">' +
                   '<div class="modal-content">' +
                     '<div class="modal-header">' +
