...
(function($) { "use strict";
  ...
  var Renderer = function() {
    var aToolbarItem = {
      picture:
        '<button type="button" class="btn btn-xs btn-default" title="Picture" data-event="showImageDialog" tabindex="-1"><i class="fa fa-picture-o"></i></button>',
      link:
        '<button type="button" class="btn btn-xs btn-default" title="Link" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="⌘+K" tabindex="-1"><i class="fa fa-link"></i></button>',
      table:
      ...
      color:
        ...
        '</ul>',
      bold:
        '<button type="button" class="btn btn-xs btn-default" title="Bold" data-shortcut="Ctrl+B" data-mac-shortcut="⌘+B" data-event="bold" tabindex="-1"><i class="fa fa-bold"></i></button>',
      italic:
        '<button type="button" class="btn btn-xs btn-default" title="Italic" data-shortcut="Ctrl+I" data-mac-shortcut="⌘+I" data-event="italic" tabindex="-1"><i class="fa fa-italic"></i></button>',
      underline:
        '<button type="button" class="btn btn-xs btn-default" title="Underline" data-shortcut="Ctrl+U" data-mac-shortcut="⌘+U" data-event="underline" tabindex="-1"><i class="fa fa-underline"></i></button>',
      clear:
        '<button type="button" class="btn btn-xs btn-default" title="Remove Font Style" data-shortcut="Ctrl+\\" data-mac-shortcut="⌘+\\" data-event="removeFormat" tabindex="-1"><i class="fa fa-eraser"></i></button>',
      ul:
        '<button type="button" class="btn btn-xs btn-default" title="Unordered list" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="⌘+⇧+7" data-event="insertUnorderedList" tabindex="-1"><i class="fa fa-list-ul"></i></button>',
      ol:
        '<button type="button" class="btn btn-xs btn-default" title="Ordered list" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="⌘+⇧+8" data-event="insertOrderedList" tabindex="-1"><i class="fa fa-list-ol"></i></button>',
      paragraph:
        ...
        '<ul class="dropdown-menu">' +
          ...
          '<button type="button" class="btn btn-xs btn-default" title="Align left" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="⌘+⇧+L" data-event="justifyLeft" tabindex="-1"><i class="fa fa-align-left"></i></button>' +
          '<button type="button" class="btn btn-xs btn-default" title="Align center" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="⌘+⇧+E" data-event="justifyCenter" tabindex="-1"><i class="fa fa-align-center"></i></button>' +
          '<button type="button" class="btn btn-xs btn-default" title="Align right" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="⌘+⇧+R" data-event="justifyRight" tabindex="-1"><i class="fa fa-align-right"></i></button>' +
          '<button type="button" class="btn btn-xs btn-default" title="Justify full" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="⌘+⇧+J" data-event="justifyFull" tabindex="-1"><i class="fa fa-align-justify"></i></button>' +
          '</div>' +
          '</li>' +
          '<li>' +
          '<div class="note-list btn-group">' +
          '<button type="button" class="btn btn-xs btn-default" title="Outdent" data-shortcut="Ctrl+[" data-mac-shortcut="⌘+[" data-event="outdent" tabindex="-1"><i class="fa fa-indent-left"></i></button>' +
          '<button type="button" class="btn btn-xs btn-default" title="Indent" data-shortcut="Ctrl+]" data-mac-shortcut="⌘+]" data-event="indent" tabindex="-1"><i class="fa fa-indent-right"></i></button>' +
          '</li>' +
        '</ul>',
      height:
        ...
        '</ul>',
      help:
        '<button type="button" class="btn btn-xs btn-default" title="Help" data-shortcut="Ctrl+/" data-mac-shortcut="⌘+/" data-event="showHelpDialog" tabindex="-1"><i class="fa fa-question"></i></button>',
      fullscreen:
        '<button type="button" class="btn btn-xs btn-default" title="Full Screen" data-event="fullscreen" tabindex="-1"><i class="fa fa-fullscreen"></i></button>',
      codeview:
        '<button type="button" class="btn btn-xs btn-default" title="Code View" data-event="codeview" tabindex="-1"><i class="fa fa-code"></i></button>'
    };
    var sPopover = '<div class="note-popover">' +
                     '<div class="note-link-popover popover bottom in" style="display: none;">' +
                       ...
                       '<div class="popover-content note-link-content">' +
                         ...
                         '<button type="button" class="btn btn-xs btn-default" title="Edit" data-event="showLinkDialog" tabindex="-1"><i class="fa fa-edit"></i></button>' +
                         '<button type="button" class="btn btn-xs btn-default" title="Unlink" data-event="unlink" tabindex="-1"><i class="fa fa-unlink"></i></button>' +
                         '</div>' +
                       '</div>' +
                     '</div>' +
                     '<div class="note-image-popover popover bottom in" style="display: none;">' +
                       ...
                       '<div class="popover-content note-image-content">' +
                         '<div class="btn-group">' +
                           '<button type="button" class="btn btn-xs btn-default" title="Resize Full" data-event="resize" data-value="1" tabindex="-1"><i class="fa fa-resize-full"></i></button>' +
                           '<button type="button" class="btn btn-xs btn-default" title="Resize Half" data-event="resize" data-value="0.5" tabindex="-1">½</button>' +
                           '<button type="button" class="btn btn-xs btn-default" title="Resize Thrid" data-event="resize" data-value="0.33" tabindex="-1">⅓</button>' +
                           '<button type="button" class="btn btn-xs btn-default" title="Resize Quarter" data-event="resize" data-value="0.25" tabindex="-1">¼</button>' +
                         '</div>' +
                         '<div class="btn-group">' +
                           '<button type="button" class="btn btn-xs btn-default" title="Float Left" data-event="float" data-value="left" tabindex="-1"><i class="fa fa-align-left"></i></button>' +
                           '<button type="button" class="btn btn-xs btn-default" title="Float Right" data-event="float" data-value="right" tabindex="-1"><i class="fa fa-align-right"></i></button>' +
                           '<button type="button" class="btn btn-xs btn-default" title="Float None" data-event="float" data-value="none" tabindex="-1"><i class="fa fa-reorder"></i></button>' +
                         '</div>' +
                       '</div>' +
                     '</div>' +
                   '</div>';
