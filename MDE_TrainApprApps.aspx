<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_TrainApprApps.aspx.cs" Inherits="LRCA.MDE_TrainApprApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Approved/Rejected Training Courses Accreditations Applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Training Courses Accreditations Closed Applications
            </h2>
            <small>This module is for MDE staff to manage Approved/Denied Training Courses Accreditations applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Approved Training Courses Accreditations Applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Rejected Training Courses Accreditations Applications
                        </a>
                    </div>
