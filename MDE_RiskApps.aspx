<%@ Page Title="" Language="C#" MasterPageFile="~/MDE.Master" AutoEventWireup="true" CodeBehind="MDE_RiskApps.aspx.cs" Inherits="LRCA.MDE_RiskApps" %>
        ...
        <div class="panel-body">
            <div id="hbreadcrumb" class="pull-right">
                <ol class="hbreadcrumb breadcrumb">
                    <li>MDE</li>
                    <li class="active">
                        <span>Pending Inspector & Risk Assessor applications</span>
                    </li>
                </ol>
            </div>
            <h2 class="font-light m-b-xs">         
          Inspector & Risk Assessor applications
            </h2>
            <small>This module is for MDE staff to manage Pending Inspector & Risk Assessor applications.</small>
        </div>
    </div>
</div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           Pending Inspector & Risk Assessor applications
                        </a>
                    </div>
                ...
                <div class="hpanel">
                    ...
                    <div class="panel-heading">
                        <a class="showhide">
                           ...
                           My Inspector & Risk Assessor applications
                        </a>
                    </div>
