<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="TP_MgmtTraineeCards.aspx.cs" Inherits="LRCA.TP_MgmtTraineeCards" %>
...
<div class="transition animated fadeIn">
      <div class="hpanel">
        <div class="panel-body">
          ...
          Trainee Training Cards </span>         
            </h2>
            <h4>Print Trainee's Training Cards from the list below<asp:Label ID="lblCrouseName" runat="server" ></asp:Label></h4>
            <small></small>
        </div>
